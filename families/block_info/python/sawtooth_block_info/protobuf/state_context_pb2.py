...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='python/sawtooth_block_info/protobuf/state_context.proto',
  package='',
  syntax='proto3',
...
_TPEVENTADDREQUEST.fields_by_name['event'].message_type = python_dot_sawtooth__block__info_dot_protobuf_dot_events__pb2._EVENT
