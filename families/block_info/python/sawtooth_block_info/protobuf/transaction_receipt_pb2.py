...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='python/sawtooth_block_info/protobuf/transaction_receipt.proto',
  package='',
  syntax='proto3',
...
_TRANSACTIONRECEIPT.fields_by_name['events'].message_type = python_dot_sawtooth__block__info_dot_protobuf_dot_events__pb2._EVENT
