...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='python/sawtooth_block_info/protobuf/client_receipt.proto',
  package='',
  syntax='proto3',
  ...
  ,
  dependencies=[python_dot_sawtooth__block__info_dot_protobuf_dot_transaction__receipt__pb2.DESCRIPTOR,])
...
_CLIENTRECEIPTGETRESPONSE.fields_by_name['receipts'].message_type = python_dot_sawtooth__block__info_dot_protobuf_dot_transaction__receipt__pb2._TRANSACTIONRECEIPT
