...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='python/sawtooth_block_info/protobuf/genesis.proto',
  package='',
  syntax='proto3',
...
_GENESISDATA.fields_by_name['batches'].message_type = python_dot_sawtooth__block__info_dot_protobuf_dot_batch__pb2._BATCH
