...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='python/sawtooth_block_info/protobuf/processor.proto',
  package='',
  syntax='proto3',
...
_TPPROCESSREQUEST.fields_by_name['header'].message_type = python_dot_sawtooth__block__info_dot_protobuf_dot_transaction__pb2._TRANSACTIONHEADER
